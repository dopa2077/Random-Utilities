package com.dopa.randomutilities.logistics.collector.client.panel;
...
public final class ItemCollectorConfigPanel extends AttachedPanel {
    ...
    private StepperButton stepperButton(String label, byte kind, int delta) {
        return new StepperButton(STEPPER_W, STEPPER_H, label, stepperTooltip(delta < 0), () -> adjustRange(kind, delta));
    }
