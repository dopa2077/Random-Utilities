package com.dopa.randomutilities.logistics.collector.client;
...
import com.dopa.randomutilities.core.gui.widget.IconButton;
...
import com.dopa.randomutilities.logistics.collector.client.panel.ItemCollectorConfigPanel;
import com.dopa.randomutilities.core.gui.panel.ScrollingInfoPanel;
import com.dopa.randomutilities.logistics.collector.ItemCollectorType;
...
public class ItemCollectorScreen extends AbstractContainerScreen<ItemCollectorMenu>
    ...
    protected void init() {
        ...
        cosmeticPanel = new RgbCosmeticPanel(
                ...
                color -> ClientPacketDistributor.sendToServer(new ItemCollectorSettingPayload(
                        ItemCollectorSettingPayload.KIND_COLOR, color)),
                this::addOverlayWidget,
                "gui.dopasrandomutilities.item_collector.cosmetic.swatch.tooltip",
                new RgbCosmeticPanel.Toggle(
                        "gui.dopasrandomutilities.item_collector.particles",
    ...
    private Component stackUpgradeTotalOverride(@Nullable Slot hoveredSlot) {
        ...
        if (hoveredSlot.getItem().getItem() instanceof MachineUpgradeItem upgrade
            ...
            var upgrades = menu.blockEntity().upgrades();
            return UpgradeSlotTooltips.stackPickupTotalLine(menu.getPickupBatch(), upgrades.stackCount());
        }
        return null;
    }
}
