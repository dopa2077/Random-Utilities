package com.dopa.randomutilities.magnet.menu;
...
import com.dopa.randomutilities.magnet.MagnetStorage;
import com.dopa.randomutilities.magnet.MagnetUpgradeInventory;
...
public class MagnetMenu extends AbstractContainerMenu implements GhostFilterMenu {
    ...
    private final MagnetUpgradeInventory upgrades;
    ...
    public MagnetMenu(int containerId, Inventory playerInv, InteractionHand hand) {
        ...
        this.upgrades = new MagnetUpgradeInventory();
        this.upgrades.loadFrom(contents);
    ...
    public MagnetUpgradeInventory upgrades() {
        return upgrades;
    }
    ...
    public ItemStack quickMoveStack(Player player, int index) {
        ...
        if (UpgradeInventory.isMagnetUpgrade(stack)
