package com.dopa.randomutilities.integration.jei.generator;
...
public final class ResourceGeneratorRecipeCategory extends AbstractRecipeCategory<GeneratorJeiRecipe> {
    ...
    public ResourceGeneratorRecipeCategory(IGuiHelper guiHelper, GeneratorType type) {
        super(
                ...
                guiHelper.createDrawableIngredient(VanillaTypes.ITEM_STACK, GeneratorJeiRecipe.stackFor(type)),
                WIDTH,
                HEIGHT
        );
