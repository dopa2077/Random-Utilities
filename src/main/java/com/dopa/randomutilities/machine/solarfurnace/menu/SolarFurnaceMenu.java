package com.dopa.randomutilities.machine.solarfurnace.menu;
...
public class SolarFurnaceMenu extends AbstractContainerMenu {
    ...
    /** Tiny sun-status square (inner fill of the custom GUI pit). */
    public static final int SOLAR_INDICATOR_X = 60;
    public static final int SOLAR_INDICATOR_Y = 57;
    public static final int SOLAR_INDICATOR_SIZE = 7;

    /** Empty thunder outline in {@code textures/gui/solar_furnace.png}; lit overlay is 14×15. */
    public static final int THUNDER_X = 56;
    public static final int THUNDER_Y = 37;
    public static final int THUNDER_W = 14;
    public static final int THUNDER_H = 15;
    ...
    /** 0–1 sun height relative to noon peak (ignores the 90% speed cap). */
    public float solarStrengthFraction() {
        if (solarStatus() != SolarPower.Status.WORKING) {
            return 0.0F;
        }
        return Mth.clamp(solarPermille() / (SolarPower.PEAK_SPEED * 1000.0F), 0.0F, 1.0F);
    }
