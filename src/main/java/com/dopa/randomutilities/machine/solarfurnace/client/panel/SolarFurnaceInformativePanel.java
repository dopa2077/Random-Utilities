package com.dopa.randomutilities.machine.solarfurnace.client.panel;
...
public final class SolarFurnaceInformativePanel extends AttachedPanel {
    ...
    public SolarFurnaceInformativePanel(int tabYBias) {
