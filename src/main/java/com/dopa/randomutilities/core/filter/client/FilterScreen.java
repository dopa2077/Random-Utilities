...
import com.dopa.randomutilities.core.util.CompactCountFormat;

import com.dopa.randomutilities.core.gui.widget.IconButton;
import com.dopa.randomutilities.core.gui.widget.VanillaContainerPanel;

import com.dopa.randomutilities.core.filter.FilterContents;
import com.dopa.randomutilities.core.filter.client.panel.ConfiguratorPanel;
import com.dopa.randomutilities.core.filter.client.panel.InformativePanel;
...
public class FilterScreen extends AbstractContainerScreen<FilterMenu> {
    ...
    protected void init() {
        ...
        if (profile != null && profile.showCosmetic()) {
            ...
            this.cosmeticPanel = new RgbCosmeticPanel(
                    cosmeticAnchor,
                    () -> menu.getColor(),
                    color -> ClientPacketDistributor.sendToServer(FilterSettingPayload.color(color)),
                    this::addOverlayWidget,
                    "gui.dopasrandomutilities.panel.cosmetic.swatch.tooltip",
                    profile.showCosmeticHighlight()
                            ? new RgbCosmeticPanel.Toggle(
                                    "gui.dopasrandomutilities.panel.cosmetic.highlight_match",
                                    "gui.dopasrandomutilities.panel.cosmetic.highlight_match.tooltip",
                                    ...
                                    () -> menu.isHighlightMatchColor(),
                                    () -> ClientPacketDistributor.sendToServer(
                                            FilterSettingPayload.highlightMatch(!menu.isHighlightMatchColor()))
                            )
                            : null
            );
