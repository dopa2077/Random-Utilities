...
import com.dopa.randomutilities.core.client.WorkingVolumeOverlay;
...
public abstract class AdvancedVolumeMachineScreen<M extends AbstractContainerMenu & VolumeMachineMenu>
    ...
    @Nullable
    private RgbCosmeticPanel mutePanel;
    @Nullable
    ...
    protected void init() {
        ...
        if (showMutePanel()) {
            mutePanel = new RgbCosmeticPanel(
                    PanelAnchor.LEFT_LOW,
                    this::overlayColor,
                    color -> sendVolumeSetting(WorkingVolume.KIND_COLOR, color),
                    this::addOverlayWidget,
                    "gui.dopasrandomutilities.working_volume.cosmetic.swatch.tooltip",
                    new RgbCosmeticPanel.Toggle(
                            "gui.dopasrandomutilities.working_volume.mute",
                            ...
                            this::isMuted,
                            () -> sendVolumeSetting(WorkingVolume.KIND_MUTE, isMuted() ? 0 : 1)
                    )
            );
