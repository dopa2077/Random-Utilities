package com.dopa.randomutilities.blockplacer.client.panel;
...
public final class SimpleBlockPlacerInformativePanel extends AttachedPanel {
    ...
    private static final String[] PARAGRAPH_KEYS = {
            "gui.dopasrandomutilities.panel.info.simple_block_placer.intro"
    };

    private final int tabYBias;
    private final PanelTextScrollbar scrollbar = new PanelTextScrollbar();

    public SimpleBlockPlacerInformativePanel(int tabYBias) {
